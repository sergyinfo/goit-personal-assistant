...
![Опис зображення](images/BROAssistant.png)
...
Нижче зазначений перелік підтримуваних команд з перекладом за замовчуванням
...
Для презентації можливості перекладу команд - ви можете включити вбудований мілітарі словник. Щоб зробити це - додайте наступний рядок в `.env`

  ```bash
  COMMANDS_PARSER=military_command_types # "military_command_types" or "command_types"
  ```

  Після чого просто перезапустіть програму щоб отримати наступний перелік команд

| Команда   | Опис                 | Параметри                                                                                                                 |
|-----------|----------------------|---------------------------------------------------------------------------------------------------------------------------|
| побратими | Керування контактами | -h, --help: show this help message and exit                                                                               |
|           |                      | інфа usage: `__main__.py побратими інфа [-h]`                                                                             |
|           |                      | + usage: `__main__.py побратими + [-h] --позивний ПОЗИВНИЙ [--днюха ДНЮХА] [--нотатки НОТАТКИ]`                           |
|           |                      | змінити usage: `__main__.py побратими змінити [-h] --жетон ЖЕТОН [--позивний ПОЗИВНИЙ] [--днюха ДНЮХА] [--нотатки НОТАТКИ]` |
|           |                      | мінус usage: `__main__.py побратими мінус [-h] --жетон ЖЕТОН`                                                             |
|           |                      | розвідка usage: `__main__.py побратими розвідка [-h] --q Q [--по ПО]`                                                     |
|           |                      | +радійка usage: `__main__.py побратими +радійка [-h] --жетон ЖЕТОН --радійка РАДІЙКА`                                     |
|           |                      | мінус_радійка usage: `__main__.py побратими мінус_радійка [-h] --жетон ЖЕТОН --радійка РАДІЙКА`                           |
|           |                      | +пошта usage: `__main__.py побратими +пошта [-h] --жетон ЖЕТОН --пошта ПОШТА`                                             |
|           |                      | мінус_пошта usage: `__main__.py побратими мінус_пошта [-h] --жетон ЖЕТОН --пошта ПОШТА`                                   |
|           |                      | +база usage: `__main__.py побратими +база [-h] --жетон ЖЕТОН --база БАЗА`                                                 |
|           |                      | мінус_база usage: `__main__.py побратими мінус_база [-h] --жетон ЖЕТОН --база БАЗА`                                       |
|           |                      | +патч usage: `__main__.py побратими +патч [-h] --жетон ЖЕТОН --патч ПАТЧ`                                                 |
|           |                      | мінус_патч usage: `__main__.py побратими мінус_патч [-h] --жетон ЖЕТОН --патч ПАТЧ`                                       |
|           |                      | днюхі usage: `__main__.py побратими днюхі [-h] [--дні ДНІ]`                                                               |
| нотатки   | Керування нотатками  | -h, --help: show this help message and exit                                                                               |
|           |                      | + usage: `__main__.py нотатки + [-h] --текст ТЕКСТ [ТЕКСТ ...]`                                                           |
|           |                      | змінити usage: `__main__.py нотатки змінити [-h] --жетон ЖЕТОН --текст ТЕКСТ [ТЕКСТ ...]`                                 |
|           |                      | мінус usage: `__main__.py нотатки мінус [-h] --жетон ЖЕТОН`                                                               |
|           |                      | розвідка usage: `__main__.py нотатки розвідка [-h] [--текст ТЕКСТ [ТЕКСТ ...]] [--патч ПАТЧ] [--жетон ЖЕТОН]`             |
|           |                      | +патч usage: `__main__.py нотатки +патч [-h] --жетон ЖЕТОН --патч ПАТЧ`                                                   |
|           |                      | мінус_патч usage: `__main__.py нотатки мінус_патч [-h] --жетон ЖЕТОН --патч ПАТЧ`                                         |
|           |                      | схрон usage: `__main__.py нотатки схрон [-h] --жетон ЖЕТОН`                                                               |
|           |                      | розкопати usage: `__main__.py нотатки розкопати [-h] --жетон ЖЕТОН`                                                       |
|           |                      | інфа usage: `__main__.py нотатки інфа [-h]`                                                                               |
|           |                      | схованка usage: `__main__.py нотатки схованка [-h]`                                                                       |
|           |                      | зміни usage: `__main__.py нотатки зміни [-h] --жетон ЖЕТОН`                                                               |
